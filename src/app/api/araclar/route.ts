...
export async function POST(req: NextRequest) {
  ...
  const arac = await prisma.t_Arac_Master.create({
    data: {
      ...
      otomatikVar: body.otomatikVar || false,
      otomatikFirma: body.otomatikFirma || null,
      otomatikKod: body.otomatikKod || null,
      etiketSinifi: body.etiketSinifi ? Number(body.etiketSinifi) : null,
      hgsKimeAit: body.hgsKimeAit || null,
      takograf: body.takograf || null,
      taahhutname: body.taahhutname || null,
      kabisVar: body.kabisVar || false,
      kabisSirket: body.kabisSirket || null,
