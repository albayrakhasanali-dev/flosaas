  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Muayene Takip</h1>
        ...
        <div className="flex items-center gap-2">
          {isAdminRole && (
            <button
              ...
              className="flex items-center gap-2 px-3 sm:px-4 py-2.5 border border-green-300 text-green-700 bg-green-50 hover:bg-green-100 rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
            >
              <Download size={16} />
          ...
          <button
            ...
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 sm:px-4 py-2.5 rounded-lg text-sm font-medium transition-colors"
          >
            <Plus size={16} />
            <span className="hidden sm:inline">Yeni Muayene Ekle</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div
            className={`bg-white rounded-xl border p-4 shadow-sm cursor-pointer transition-colors ${
              fDurum === "" && !fSonuc && !fMuayeneTipi ? "border-blue-400 bg-blue-50" : "border-slate-200 hover:border-slate-300"
            }`}
            onClick={() => { setFDurum(""); setFSonuc(""); setFMuayeneTipi(""); }}
          >
          ...
          <div
            className={`bg-white rounded-xl border p-4 shadow-sm cursor-pointer transition-colors ${
              fDurum === "gecerli" ? "border-green-400 bg-green-50" : "border-green-200 hover:border-green-300"
            }`}
            onClick={() => setFDurum(fDurum === "gecerli" ? "" : "gecerli")}
          >
            <div className="flex items-center justify-between">
              <div>
